  ...
  <div class="sys">
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="info" label="库存" />
        <el-table-column prop="info" label="零售价" />
        <el-table-column prop="info" label="会员价" />
        <el-table-column prop="info" label="今日" />
        <el-table-column prop="info" label="昨日" />
        <el-table-column prop="info" label="全部" />

        <el-table-column prop="sort" label="排序(越小越前)" />
        <el-table-column prop="info" label="推广连接" />
